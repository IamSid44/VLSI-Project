...
#set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports {A[0]}]
set_property -dict {PACKAGE_PIN T2 IOSTANDARD LVCMOS33} [get_ports {Rst}]
#set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS33} [get_ports {A[2]}]
...
#set_property -dict {PACKAGE_PIN M2 IOSTANDARD LVCMOS33} [get_ports {Y[2]}]
...
# PMOD Output
set_property -dict {PACKAGE_PIN B13 IOSTANDARD LVCMOS33} [get_ports {S[0]}]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports {S[1]}]
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33} [get_ports {S[2]}]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports {S[3]}]
set_property -dict {PACKAGE_PIN B14 IOSTANDARD LVCMOS33} [get_ports {Cout}]
...
#set_property -dict {PACKAGE_PIN B2 IOSTANDARD LVCMOS33} [get_ports {Xval[1]}]
...
#set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33} [get_ports {Clr}]
